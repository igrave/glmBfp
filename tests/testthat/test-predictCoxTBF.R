test_that("coxTBF works with uc terms", {
  ...
  expect_equal(
    result,
    matrix(
      c(0.583350689483257, 0.669476472133622, 0.583350689483257, 
...
test_that("predict works with coxTBF with sep = TRUE", {
  ...
  expect_equal(
    result,
    matrix(
      c(0.404734875321373, 0.52178924629397, 0.404734875321373, 
...
test_that("predict.TBFcox.BMA works", {
  ...
  expect_equal(
    result,
    matrix(
      c(0.4051163842681, 0.527023583809112, 0.4051163842681, 
